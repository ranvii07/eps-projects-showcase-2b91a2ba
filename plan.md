...
- `src/components/site/` (new folder): `Navbar.tsx`, `Footer.tsx`, `Hero.tsx`, `About.tsx`, `Services.tsx`, `ClientsBanner.tsx`, `FAQ.tsx`, `Contact.tsx`, `ContactForm.tsx`, `ContactInfo.tsx`, `PageHeader.tsx`, `ScrollToTop.tsx`
- Routes: `src/routes/index.tsx` (Home), `about.tsx`, `services.tsx`, `projects.tsx`, `clients.tsx`, `contact.tsx`, `privacy.tsx`, `terms.tsx`
...
2. Headless Playwright: `/`, `/about`, `/services`, `/projects`, `/clients`, `/contact`, `/privacy`, `/terms`, `/admin/login` render with no console errors; navbar scroll, FAQ accordion, contact-form toast, marquee, footer year all behave; `/admin/dashboard` redirects to `/admin/login` when signed out
